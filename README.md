...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libsolv-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libsolv-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libsolv libsolv-static
# for installing globally
pixi global install libsolv libsolv-static
```
...
It is possible to list all of the versions of `libsolv` available on your platform:
...
```
pixi search libsolv --channel conda-forge
```
